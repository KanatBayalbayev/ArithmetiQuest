...
import com.qanatdev.arithmetiquest.domain.usecases.FormulateQuestionUseCase
import com.qanatdev.arithmetiquest.domain.usecases.GetGameConfigurationUseCase
...
class MainViewModel(
    ...
    private val getGameSettingsUseCase = GetGameConfigurationUseCase(repository)
    ...
    private val _gameResult = MutableLiveData<Outcome>()
    val gameResult: LiveData<Outcome>
        get() = _gameResult
